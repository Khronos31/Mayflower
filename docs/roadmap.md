...
| node | 索引に無い（同上） | ← 収録した（24.21.0、ビルドは Mac） |
| ripgrep | 索引にあるが 12.1.1 | ← 収録した（15.2.0、端末の rustc） |
| ruby | 索引に無い（同上） | ← 収録した（4.0.6、YJIT なし） |
| luarocks | 索引に無い | ← 収録した（3.13.0） |
...
| lua | 5.4.2 | 5.5.1 | ← 収録した（5.5.1） |
| perl | 5.32.1 | 5.42.0 | ← 収録した（5.42.0） |
| openssl | 3.2.1 | 4.0.2 | |
| git | 2.39.1 | — | |
| sqlite3 | 3.34.1 | — | |
| curl | 8.7.1 | — | |
